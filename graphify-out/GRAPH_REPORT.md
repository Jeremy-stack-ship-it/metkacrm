...
## Corpus Check
- 84 files · ~114,310 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 557 nodes · 974 edges · 35 communities (27 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `56b755e7`
...
1. `MetkaCRM()` - 42 edges
2. `Changelog — Metka Field Ops CRM` - 24 edges
3. `inp()` - 22 edges
...
Cohesion: 0.06
Nodes (53): StageStepper(), DashboardTab(), useAuth(), ACTIVITY_TYPES, aggregateActivity(), computeActivityQueue(), CONTACT_DISPS, dayKey() (+45 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (38): AddLeadForm(), AppointmentConfirmModal(), APPT_TYPE_LABELS, inputSt, APP_STATUSES, ContactDetail(), ECON_STAGES, UnderwritingCard() (+30 more)
...
Cohesion: 0.06
Nodes (52): DialQueuePanel(), SessionStrip(), SmsThread(), AUTO_CALLBACKS, buildDispositionPatch(), DISP_NOTE_TEXT, DISP_STAGE_MAP, addDaysISO() (+44 more)
...
Cohesion: 0.05
Nodes (36): [2026-04-01] v1.0.0 — Initial Build, [2026-05-01] v2.0.0 — Ministry Lead Operating System, [2026-05-13] v3.6 — Modular Architecture Refactor, [2026-05-14] v3.6.1 — Power Dialer + Audit Fixes, Added, Added, Added, Added (+28 more)
...
## Knowledge Gaps
- **248 isolated node(s):** `Added`, `Changed`, `Fixed`, `Dependencies`, `Notes` (+243 more)
...
- **Why does `MetkaCRM()` connect `Community 0` to `Community 33`, `Community 1`, `Community 4`, `Community 6`, `Community 7`, `Community 11`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `priority()` connect `Community 0` to `Community 1`?**
