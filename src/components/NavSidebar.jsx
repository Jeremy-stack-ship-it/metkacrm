...
const GROUPS = [
  {
    ...
    items: [
      ...
      { id: 'dial',         icon: '\U0001f399', label: 'DIAL'  },
      { id: 'callbacks',    icon: '\U0001f4de', label: 'CB'    },
      { id: 'appointments', icon: '\U0001f4c5', label: 'APPTS' },
    ],
  },
  {
    id:    'intel',
    ...
    label: 'INTEL',
    items: [
      { id: 'dashboard', icon: '\U0001f3e0', label: 'DASH' },
      { id: 'activity',  icon: '\U0001f3af', label: 'ACT'  },
      { id: 'sequence',  icon: '\U0001f501', label: 'SEQ'  },
      { id: 'cc',        icon: '\U0001f4e7', label: 'CC'   },
    ],
  },
  {
    id:    'data',
    ...
    label: 'DATA',
    items: [
      { id: 'contacts', icon: '\U0001f4c7', label: 'DATA' },
      { id: 'pipeline', icon: '\U0001f4ca', label: 'PIPE' },
    ],
  },
  {
    id:    'content',
    ...
    label: 'CONTENT',
    items: [
      { id: 'scripts',   icon: '\U0001f4dd', label: 'SCRIPT' },
      { id: 'templates', icon: '\U0001f4ac', label: 'SMS'    },
    ],
  },
];
