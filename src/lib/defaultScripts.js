...
const DEFAULT_SCRIPTS = {
  ...
  "Life Insurance": {
    phone: `B.E.S.T. PHONE OPENER — LIFE INSURANCE\n\n"Hey [FIRST_NAME]? — Hey, this is ${BRAND.name}. I'm calling about your request for life insurance coverage."`,
  ...
  "Clearance Campaign (B/C Bucket)": {
    phone: `CLEARANCE CAMPAIGN — WARM/COLD RE-ENGAGEMENT\n\nFor leads 3-12+ months old. Fast, low-pressure, designed for volume.\n\n"Hey [FIRST_NAME]? — Hey, this is ${BRAND.name}. I'm not sure if you remember, but [TIME PERIOD] ago you had inquired about some life insurance coverage for your family."`,
  ...
  "Policy Review (Book of Business)": {
    phone: `WORKING YOUR BOOK OF BUSINESS\n\nFor past clients — annual policy reviews + upsell opportunity.\n\n"Hi, can I speak with [FIRST_NAME]? This is ${BRAND.name}, the insurance agent who helped with your policy..."`,
